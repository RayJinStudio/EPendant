...
public:
    CST816T();
    CST816T(gpio_num_t rst_n, gpio_num_t int_n);
    CST816T(gpio_num_t sda, gpio_num_t scl, gpio_num_t rst_n, gpio_num_t int_n); 
    virtual ~CST816T(); 
...
private:
    ...
    gpio_num_t int_n = GPIO_NUM_NC; 
    gpio_num_t rst_n = GPIO_NUM_NC; 
